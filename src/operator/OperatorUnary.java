...
public class OperatorUnary {
    public static void main(String[] args) {
        ...
        System.out.println(i);      //betulkan i nilainya jadi 1
        i++;                        //karena i tadinya sudah bernilai 1 maka sekarang lagi menjadi 2
        System.out.println(i);      //tuh betulkan nilainya 2
        i=i+1;                      //bisa dilihat i++ sama dengan i = i+1
        System.out.println(i);      //i tadi sekarang jadi 3
